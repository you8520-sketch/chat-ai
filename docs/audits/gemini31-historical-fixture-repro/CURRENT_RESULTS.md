...
| call | VISIBLE_CHARS_INCL_SPACES | VISIBLE_CHARS_EXCL_SPACES | PARAGRAPH_COUNT | DIALOGUE_PARAGRAPH_COUNT | DIALOGUE_PARAGRAPH_RATIO | INPUT_TOKENS | OUTPUT_TOKENS | THINKING_TOKENS | CACHE_READ | CACHE_WRITE | LATENCY_MS | TTFT_MS | FINISH_REASON | REQUEST_SHA | RAW_SHA |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
No model text was produced. No `MALFORMED_OUTPUT`, `META_LEAK`, `EMPTY_OUTPUT`, `PROVIDER_ERROR`, `TRUNCATION`, `NEW_USER_DIALOGUE_CANDIDATE`, `NEW_USER_ACTION_CANDIDATE`, `CANON_CONTRADICTION_CANDIDATE`, or `REPETITION_CANDIDATE` passage exists to quote.
