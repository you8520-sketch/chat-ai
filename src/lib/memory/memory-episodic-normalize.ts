import type {
  ...
  EpisodicFactCategory,
  EpisodicFactEvidenceType,
  EpisodicFactImportance,
} from "./memory-episodic-types";

const FACT_CATEGORIES = new Set<EpisodicFactCategory>([
  "relationship",
  "character",
  "setting",
  "item",
...
const FACT_IMPORTANCE = new Set<EpisodicFactImportance>([
  "critical",
  "important",
  "normal",
]);

const FACT_EVIDENCE_TYPES = new Set<EpisodicFactEvidenceType>([
...
export function sanitizeEpisodicExtractedFacts(
  raw: unknown,
