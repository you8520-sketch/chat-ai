...
const VALID_REPLIES = [
  { kind: "natural" as const, text: "*손을 뻗으며* \"잠깐, 그 말부터 다시 들어보자.\" *눈을 맞추며*" },
  { kind: "twist" as const, text: "*미소 지으며* \"괜찮아, 천천히 말해도 돼.\" *어깨를 풀며*" },
  { kind: "banter" as const, text: "*시계를 보며* \"일단 밥부터 먹고 얘기할까?\" *문 쪽을 가리키며*" },
];
