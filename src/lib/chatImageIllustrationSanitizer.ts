...
export const ADULT_GROUNDED_NON_EXPLICIT_ALLOWANCE =
  "When characters are confirmed adults, non-explicit adult intimacy is allowed: embrace, kiss, closeness, shirtless adult male torso, bare shoulders, covered bedroom aftermath, flushed or shy expressions, slightly heated emotional tone, lying side by side on a bed, soft sheet or blanket coverage, and gently disheveled bedding mood — still no explicit sexual acts or exposed genitals.";
