...
const previousVercelToken = process.env.TURSO_DATABASE_TURSO_AUTH_TOKEN;
...
afterEach(() => {
  ...
  if (previousVercelToken == null) delete process.env.TURSO_DATABASE_TURSO_AUTH_TOKEN;
  else process.env.TURSO_DATABASE_TURSO_AUTH_TOKEN = previousVercelToken;
});
...
describe("remote database configuration", () => {
  ...
  it("accepts the auth token name generated by the Vercel Turso integration", () => {
    process.env.TURSO_DATABASE_URL = "libsql://chat-ai.example.turso.io";
    delete process.env.TURSO_AUTH_TOKEN;
    process.env.TURSO_DATABASE_TURSO_AUTH_TOKEN = "vercel-generated-token";
    assert.deepEqual(getRemoteDatabaseConfig(), {
      url: "libsql://chat-ai.example.turso.io",
      authToken: "vercel-generated-token",
    });
  });
});
