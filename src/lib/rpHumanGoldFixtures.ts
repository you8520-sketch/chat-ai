/**
 * Human-gold evaluator seeds for DeepSeek RP quality regressions.
 *
 * These detectors encode the redesigned premises from
 * docs/audits/36-deepseek-human-gold/HUMAN_REVIEW_FINAL.md.
