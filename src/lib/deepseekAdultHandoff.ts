...
/** Experiment A: completion only. Style mirror stays off until Experiment B. */
export const DEEPSEEK_ADULT_HANDOFF_EXPERIMENT_A = {
...
/**
 * User-turn DeepSeek adult-handoff adapters.
...
export function resolveDeepSeekAdultHandoffUserBlocks(input: {
  ...
  const experiment = input.experiment ?? DEEPSEEK_ADULT_HANDOFF_EXPERIMENT_A;
  return {
