...
/**
 * Production wire — G10-D3 Arm V semantics:
...
export function applyProductionServerControlsToMessages(input: {
  ...
  return {
    ...
    replacedSceneFlow: applied.replacedSceneFlow,
    terminalDialogueBudgetAppended: applied.terminalDialogueBudgetAppended,
  };
}
