/**
 * Phase G10-SD1 / G10-SD2 / G10-SD3 — Scene Pacing + Scene State Authority.
 *
 ...
 * G10-SD3 Arm R sole variable: REPLACE SCENE_FLOW with compact [SCENE STATE]
 * envelope (fact authority + transition scope). No parallel [SCENE PACING] stack.
 * No new negative rule list. No classifier / cooldown / probability edits.
 */
...
export type ScenePacingArm = "A" | "P" | "Q" | "R";
