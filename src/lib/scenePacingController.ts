/**
 * Phase G10-SD1 / G10-SD2 / G10-SD3 / G10-D1 — Scene Pacing + Dialogue Block Cap.
 *
 ...
 * G10-SD3 Arm R: SCENE STATE envelope (sealed FAIL — not used by G10-D1).
 * G10-D1 Arm T sole variable: Q + single_primary [대화 운용] block-cap owner
 * (REPLACE/integrate into closest dialogue owner; no % quota; not for sim/party).
 */
...
export type ScenePacingArm = "A" | "P" | "Q" | "R" | "T";
 ...
 * - T: G10-D1 — Q + single_primary [대화 운용] dialogue block cap
 */
