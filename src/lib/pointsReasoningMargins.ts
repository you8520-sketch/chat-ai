...
/** GPT-5.6 Terra direct-list fallback. Live CheaperInference catalog wins when available. */
export const CHEAPER_INFERENCE_GPT_56_TERRA_INPUT_USD_PER_MILLION = 2;
...
export const CHEAPER_INFERENCE_GEMINI_37_FLASH_CACHE_WRITE_USD_PER_MILLION = 0.525;
export const CHEAPER_INFERENCE_GEMINI_37_FLASH_OUTPUT_USD_PER_MILLION = 2.625;
...
export const CHEAPER_INFERENCE_GEMINI_37_FLASH_GROSS_MARGIN = 0.55;
...
const CHEAPER_INFERENCE_GEMINI_37_FLASH_PRICING: ReasoningTokenPricing = {
  modelId: CHEAPER_INFERENCE_GEMINI_37_FLASH_MODEL,
  inputUsdPerMillion: CHEAPER_INFERENCE_GEMINI_37_FLASH_INPUT_USD_PER_MILLION,
  cacheReadUsdPerMillion:
  ...
  outputUsdPerMillion: CHEAPER_INFERENCE_GEMINI_37_FLASH_OUTPUT_USD_PER_MILLION,
  grossMargin: CHEAPER_INFERENCE_GEMINI_37_FLASH_GROSS_MARGIN,
};
...
function resolveReasoningTokenPricing(modelId: string): ReasoningTokenPricing | null {
  ...
  if (isCheaperInferenceGemini37FlashModel(modelId)) {
    return withLiveCheaperInferenceCatalogPricing(
      CHEAPER_INFERENCE_GEMINI_37_FLASH_PRICING
    );
  }
