...
export const LEGACY_GENRE_TONE_HINTS: Partial<Record<CharacterGenre, string>> = {
  ...
  SF: "SF 세계관 분위기 유지; 대사 register 현대 존댓말(합니다·입니다·그렇습니다)",
  "로맨스 판타지":
    "판타지 분위기 유지; 감정은 행동·거리로 — 대사 register 현대 존댓말(합니다·입니다)",
  "현대 판타지": "현대+판타지; 대사 register 현대 존댓말(합니다·입니다·그렇습니다)",
  무협: "무협 분위기; 대사 하오·이오체 허용 — 캐릭터당 한 register, 턴 안 섞지 마라",
  동양풍: "동양 세계관 분위기; 대사 register는 캐릭터에 맞게 일관 유지",
  인외: "세계관 감각 유지; 대사 register 현대 존댓말(합니다·입니다)",
  "현대/일상": "현대적 리듬; 대사 register 현대 존댓말(합니다·입니다·그렇습니다)",
  학원: "현대적 리듬; 대사 register 현대 존댓말(합니다·입니다)",
  스포츠: "현대적 리듬; 대사 register 현대 존댓말(합니다·입니다)",
  ...
  HL: "감정은 행동·거리 — 대사 register 현대 존댓말(합니다·입니다·해요)",
  센티넬버스: "센티넬버스 세계관 분위기; 대사 register 현대 존댓말",
  아포칼립스: "생존·긴장 분위기; 대사 register 현대 존댓말",
...
export const STEP43_GENRE_TONE_HINTS: Partial<Record<CharacterGenre, string>> = {
  판타지: "판타지 세계관의 분위기만 유지하되 번역투·고어체로 과장하지 마라",
  SF: "SF 세계관의 분위기만 유지하되 번역투·설정 과장 금지",
  "로맨스 판타지":
    "판타지 분위기는 유지하고, 감정은 설명하지 말고 행동·거리감·호흡으로 표현한다",
  "현대 판타지": "현대와 판타지 분위기를 구분하되, 감정은 행동·감각으로",
  무협: "무협 분위기만 유지하되 고어체·번역투 과장 금지",
  동양풍: "동양 세계관 분위기만 유지하되 번역투·고어체 과장 금지",
  인외: "세계관의 감각·설정에 맞게, 감정은 행동·반응으로",
  "현대/일상": "현대적 리듬 — 구체적 일상 디테일·행동으로",
  학원: "현대적 리듬 — 구체적 일상 디테일·행동으로",
  스포츠: "현대적 리듬 — 구체적 일상 디테일·행동으로",
  ...
  HL: "감정은 설명하지 말고 행동·거리감·호흡으로 표현한다",
  센티넬버스: "센티넬버스 세계관 분위기만 유지하되 설정 과장 금지",
  아포칼립스: "생존·긴장 분위기 — 감정 라벨 대신 감각·행동으로",
  기타: "장르 분위기 유지",
};
