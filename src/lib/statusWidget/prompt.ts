...
/** Status widget is not the episodic owner. Keep extracted_facts empty. */
export const EXTRACTED_FACTS_STATUS_VALUES_INSTRUCTIONS =
  STATUS_WIDGET_NO_EPISODIC_OWNERSHIP_INSTRUCTIONS;
export const STATUS_EPISODIC_INSTRUCTIONS_REMOVED_CHARS = 4945;
