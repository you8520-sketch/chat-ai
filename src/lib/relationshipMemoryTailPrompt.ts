...
thoughts는 이번 턴 캐릭터·NPC 관점으로 **${THOUGHTS_PER_TURN_MIN_TARGET}~${THOUGHTS_PER_TURN_MAX}개** — 행동·상황 설명이 아니라 그 뒤의 내적 동기·감정으로 추정. 저장은 최근 ${MEMORY_META_MAX.thoughts}개(오래된 것부터 삭제).
