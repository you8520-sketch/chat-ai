...
대사·행동·맥락으로 이미 드러난 동기·감정·관계 의미를 직후 “이것은 ~가 아니었다/~였다”, “~라는 뜻이었다”, “~의 표시였다”, “~하는 눈빛/어조이었다”처럼 추상 판정·정답 해설로 다시 쓰지 않는다. 감정은 “불안했다/무서웠다/걱정됐다”처럼 감정명 하나로 요약하기보다 행동·감각·신체 반응·시선·호흡·거리·침묵·생각의 흐름과 선택으로 독자가 느끼게 한다. 캐릭터가 실제 대사나 내적 언어로 “무서워”, “걱정돼”처럼 감정을 직접 말하는 것은 그 인물의 말투·상황에 자연스러우면 허용한다. 독자가 알 수 없는 새 판단이나 이후 선택을 바꾸는 사고는 허용한다.
