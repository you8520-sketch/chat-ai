...
export const CHAT_PORTRAIT_GRID_CLASS =
  "grid min-w-0 flex-1 grid-cols-1 items-start sm:grid-cols-[auto_minmax(0,620px)] sm:justify-center sm:gap-x-2";
...
export const CHAT_MESSAGES_COLUMN_NO_PORTRAIT_CLASS =
  "flex min-h-[calc(100dvh-2.75rem)] min-w-0 flex-1 flex-col sm:mx-auto sm:w-full sm:max-w-[620px] md:min-h-[calc(100dvh-5.25rem)]";
