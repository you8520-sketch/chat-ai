...
- Do not output sheet HTML, internal/system markers, or chain-of-thought except the explicitly allowed asset markers supplied for this turn. Asset markers are output-control syntax only and must appear only inside NARRATION.
