...
/** Bot-seat output headroom for one semantic PC action beat (not tied to prose char caps). */
...
export function parseTrpgBillingMode(value: unknown): TrpgBillingMode | null {
  return value === "split_even" || value === "host_pays" ? value : null;
}
