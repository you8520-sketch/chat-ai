...
export const SCENARIO_STORY_FIELD_COPY = {
  ...
  summary: {
    label: "플레이어 공개 소개",
    helper:
      "TRPG 목록과 시작 전 화면에서 플레이어에게 표시됩니다. 스포일러 없이 어떤 상황과 플레이를 기대할 수 있는지 소개해 주세요.",
  },
  startingSituation: {
    label: "시작 상황",
    helper:
      "이야기가 어디서 어떤 상황으로 시작하는지만 적어 주세요. 복잡하게 설계할 필요는 없습니다.",
  },
  goal: {
    label: "플레이어 목표",
    helper:
      "플레이어들이 무엇을 하려는 이야기인지 적어 주세요. 퀘스트 구조나 종료 조건까지 설계할 필요는 없습니다.",
  },
  gmNotes: {
    label: "GM 추가 설정 (선택)",
    helper:
      "플레이어에게 공개되지 않습니다. 숨겨진 진실, 반전, 등장했으면 하는 사건이나 단서, 원하는 분위기, 피하고 싶은 전개, 엔딩 아이디어 등 GM이 참고했으면 하는 내용을 자유롭게 적으세요. 전부 작성할 필요는 없습니다. 아이디어가 없으면 비워 두어도 됩니다.",
    placeholder:
      "예:\n중반쯤 연구소장이 감염 사실을 숨기고 있다는 게 밝혀졌으면 좋겠다.\n오래된 기록을 발견하는 장면이 한 번 있으면 좋겠고,\n너무 비극적으로 끝나지는 않았으면 한다.",
  },
  content: {
    label: "플레이어 공개 추가 설정",
