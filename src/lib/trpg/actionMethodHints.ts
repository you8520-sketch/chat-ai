...
export const ACTION_METHOD_STAT_HINTS: Record<string, readonly string[]> = {
  ...
  acc: ["조준", "사격", "활", "총", "명중", "원거리", "정밀", "엄호"],
  mag: ["주문", "마법", "마력", "화염", "빙결", "번개", "소환", "초능력", "염력"],
  int: ["분석", "패턴", "구조", "연결", "흐름", "확인", "연구", "추론", "해석", "계산", "단서", "정리", "경로"],
  per: ["관찰", "흔적", "살핀", "살피", "둘러", "주시", "들여다", "탐색", "수색", "기척", "찾"],
  ins: ["직감", "육감", "감", "예감", "느낌"],
  wis: ["판단", "통찰", "감지", "치료", "붕대", "지혈", "응급", "해독", "간호"],
  rec: ["치료", "치유", "붕대", "지혈", "응급", "회복"],
  tec: ["장치", "해제", "수리", "자물쇠", "기계", "도구", "해킹", "조작", "분해"],
  con: ["버티", "막", "몸으로", "체구", "맷집", "지구력", "버텨", "견디", "넓은"],
  grd: ["가드", "막기", "패링", "받아치", "방패"],
  res: ["저항", "견디", "독", "해독", "면역"],
  wil: ["정신", "의지", "굴복", "공포", "저항"],
  cha: ["설득", "협상", "위압", "매력", "화술"],
